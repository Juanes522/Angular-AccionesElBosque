...
export class PortfolioComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.sharedData.loading$.subscribe(loading => this.loading = loading);
    this.sharedData.error$.subscribe(error => this.errorMessage = error);
    this.sharedData.stockData$.subscribe(data => {
      if (data) {
        this.selectedStock = {
          symbol: data.symbol,
